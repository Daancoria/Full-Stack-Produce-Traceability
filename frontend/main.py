...
class MushroomApp:
    def __init__(self, root):
        # Initialize main window and app state
        self.root = root
    ...
    def on_close(self):
        # Save logs and close app
        self.save_logs()
        self.root.destroy()

    def add_theme_toggle_button(self):
        # Add button to toggle between light/dark themes
    ...
    def toggle_theme(self):
        # Switch between themes and save preference
    ...
    def build_gui(self):
        ...
        # List of action buttons and their handlers
        actions = [
        ...
        # Stretch layout for form and button frames
        for frame in [form_frame, button_frame]:
            frame.columnconfigure(1, weight=1)

    def pick_date(self, target_var):
        # Show a date picker dialog and set the selected date
    ...
    def confirm_add(self):
        # Confirm and add a new delivery entry
    ...
    def validate_inputs(self):
        # Validate form inputs before adding a log
        try:
    ...
    def generate_label(self):
        # Generate a formatted log label from form data
    ...
    def load_logs(self):
        # Load logs from file, or create new if missing
    ...
    def clear_logs(self):
        # Clear all logs after confirmation and backup
        if not self.logs:
    ...
    def backup_logs(self):
        # Backup logs to a timestamped file in the backups folder
    ...
    def save_settings_from_ui(self, window):
        # Save settings from the settings window UI
    ...
    def view_log(self):
        # Show a preview of filtered logs
    ...
    def show_charts(self):
        # Display charts for deliveries per mushroom type and date
        if not self.logs:
    ...
    def export_summary_report(self):
        # Export a summary report as Word and PDF
        if not self.logs:
        ...
        try:
            ...
            if logo_path and os.path.exists(logo_path):
                ...
                if img_width_inch > max_width_inch:
                    ...
                    doc.add_picture(absolute_logo_path)
        except Exception as e:
    ...
    def update_export_button_state(self):
        # Enable/disable export button based on log state
    ...
    def generate_invoice(self):
        # Generate an invoice for the latest entry as Word and PDF
        if not self.logs:
    ...
    def toggle_mode(self):
        # Toggle between mock and live mode, restart app if confirmed
    ...
    def browse_invoice_template(self):
        # Open file dialog to select invoice template
        filepath = filedialog.askopenfilename(
    ...
    def export_data(self):
        # Export data in the preferred format
        if not self.logs:
            self.show_toast("No data to export.", "error")
            return
    ...
    def restore_backup(self):
        # Restore logs from a selected backup file
        base_folder = self.settings.get("export_folder", "")
        if not base_folder:
            base_folder = "."
        backup_folder = os.path.join(base_folder, "backups")
    ...
    def load_backup_list(self):
        # Load backup files into the backup manager listbox
    ...
    def restore_selected_backup(self):
        # Restore logs from the selected backup in the manager
